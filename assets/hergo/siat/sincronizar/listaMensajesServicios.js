	...
	methods:{
                ...
                $.ajax({
                    ...
                    data:{
                        cliente: {
                            ...
                            method: 'sincronizarListaMensajesServicios'
                        }
                    }
                }).done(function (res) {
                    quitarcargando()
                    ...
                    table = sincro.table(listaCodigos, columns)
        ...
        sincronizar(){
            ...
            if (sincro.datasiat) {
                $.ajax({
                    type: "post",   
                    url: base_url('index.php/Siat/sincronizacion/Sincronizar/sincronizarMensajesServicios'),
                    dataType: "json",   
                    data: {
