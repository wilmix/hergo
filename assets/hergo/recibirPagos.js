...
function mostrarTablaDetalle(res)
{
    ...
    $("#tabla2detalle").bootstrapTable('destroy');
        $("#tabla2detalle").bootstrapTable({
            ...
            //se puede editar la cantidad antes de grabar
            {
                field:'cantidadReal',
                title:"Cantidad",
                align: 'right',                
            ...
            },*/
            {
                ...
                title:'<button type="button" class="btn btn-default agregarTodos"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></button>',
                align: 'center',
                class:"col-sm-1",
                events: operateEvents,
