...
class FacturaTipoPago extends CI_Controller
{
	...
	public function index()
	{
		...
		if(!$this->session->userdata('logeado'))
			...
			$this->load->view('reportes/facturaTipoPago.php',$this->datos);
