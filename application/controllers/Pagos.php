...
class Pagos extends CI_Controller
{
	...
	public function index()
	{
		if(!$this->session->userdata('logeado'))
			...
			$this->datos['cabeceras_script'][]=base_url('assets/hergo/consultaPagos.js');
			...
			$this->load->view('pagos/consultarPagos.php',$this->datos);
	...
	public function RecibirPago()
	{
		if(!$this->session->userdata('logeado'))
			...
			/**************FUNCION***************/
			$this->datos['cabeceras_script'][]=base_url('assets/hergo/funciones.js');
			$this->datos['cabeceras_script'][]=base_url('assets/hergo/recibirPagos.js');
			$this->datos['cabeceras_script'][]=base_url('assets/hergo/NumeroALetras.js');
			/**************INPUT MASK***************/
			$this->datos['cabeceras_script'][]=base_url('assets/plugins/inputmask/inputmask.js');
			$this->datos['cabeceras_script'][]=base_url('assets/plugins/inputmask/inputmask.numeric.extensions.js');
