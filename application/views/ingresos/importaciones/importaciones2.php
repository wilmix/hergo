...
if ($cont) {
  ...
  $fechaKardex = $dcab->fechaIngreso;
  $fechaKardex = date("Y-m-d", strtotime($fechaKardex));
  /* echo $newDate."\n";
          echo $fechaKardex;
          die(); */
      ...
      <div class="box-body">
        <form action="" method="post" id="form_ingresoImportaciones">
          <div class="form">
            <!-- OCULTO ID-->
            <?php if ($cont) : ?>
              <input id="idingresoimportacion" name="idingresoimportacion" type="text" class="hidden" value="<?= $dcab->idIngresos ?>">
            <?php endif ?>
            <div>
            ...
            <div class="row">
              ...
              <div class=" col-xs-6 col-sm-6 col-md-3">
                ...
                <select class="form-control form-control-sm" id="almacen_imp" name="almacen_imp" <?= ($cont) ? "disabled" : "" ?>>
                  ...
                  <?php foreach ($almacen->result_array() as $fila) : ?>
                    <option value=<?= $fila['idalmacen'] ?> <?= ($idalmacen == $fila['idalmacen']) ? "selected" : "" ?>>
                      <?= $fila['almacen'] ?></option>
                  <?php endforeach ?>
                </select>
              </div>
              ...
              <div class=" col-xs-6 col-sm-6 col-md-3">
                ...
                <select class="form-control form-control-sm" id="tipomov_imp2" name="tipomov_imp2" <?= ($cont) ? "disabled" : "" ?>>
              ...
              <div class="col-xs-6 col-sm-6 col-md-2">
                ...
                <input id="fechamov_imp" type="text" class="form-control form-control-sm fecha_ingreso" name="fechamov_imp" placeholder="Fecha" value="<?= ($cont) ? $newDate : ''  ?>" <?= ($cont) ? "" : "autofocus" ?> />
              </div>
              <!-- moneda -->
              <div class="col-xs-6 col-sm-6 col-md-2">
              ...
              <div id="tipoNumFactura">
                <div class="col-xs-4 col-sm-4 col-md-3">
                  ...
                  <select class="form-control form-control-sm" id="tipoDoc" name="tipoDoc">
                    ...
                    <option value="2" <?= ($tipoDoc == 2) ? "selected" : "" ?>>SIN FACTURA (BIENES) </option>
                    <option value="3" <?= ($tipoDoc == 2) ? "selected" : "" ?>>SIN FACTURA (SERVICIOS)</option>
                    <option value="4" <?= ($tipoDoc == 3) ? "selected" : "" ?>>EN TRANSITO </option>
                  </select>
                </div>
                <div class="col-xs-4 col-sm-4 col-md-2">
                  <label class="tipoDocumento hidden">N° Factura:</label>
                  <input id="nfact_imp" name="nfact_imp" type="text" class="form-control form-control-sm  tipoDocumento hidden" placeholder="# Factura" value="<?= ($cont) ? $dcab->nfact : "" ?>">
                </div>
              </div>
              <!-- flete -->
              <div class="col-xs-4 col-md-2">
                <label for="flete">Flete:</label>
                <input type="number" style="text-align:right;" class="form-control form-control-sm" id="flete" name="flete" value="<?= ($cont) ? $dcab->flete : 0 ?>" />
              </div>
              <!-- fecha -->
              <div class="col-xs-6 col-sm-6 col-md-2">
                <label>Fecha Kardex:</label>
                <input id="fecha_kardex" type="text" class="form-control form-control-sm fecha_kardex" name="fecha_kardex" placeholder="FechaKardex" value="<?= ($cont) ? $fechaKardex : ''  ?>" <?= ($cont) ? "" : "autofocus" ?> />
              </div>
