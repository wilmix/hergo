          ...
          <?php if ($cont): ?>
            ...
            <div class="row filacabecera"> <!--PRIMERA FILA-->
               ...
               <div class="col-xs-6 col-sm-6 col-md-2">
                  <label>Fecha:</label>
                  <input id="fechamov_tra" type="date" class="form-control form-control-sm" name="fechamov_tra" placeholder="Fecha" value="<?= ($cont)?$newDate:$fecha  ?>" tabindex=3 <?= ($cont)?"disabled":"" ?>>
               </div>
               <div class="col-xs-6 col-sm-6 col-md-2">
                  <label>Moneda:</label>
                  <select class="form-control form-control-sm" id="moneda_tra" name="moneda_tra" tabindex=4>
               ...
               <div class="col-xs-4 col-sm-4 col-md-2">
                      ...
                      <input id="pedido_tra" type="text" class="form-control form-control-sm" tabindex=6 value="<?= ($cont)?$dcab->clientePedido:''  ?>">
                </div>
                ...
                <div class="row filaarticulo"> <!--TERCERA FILA-->
                  <div class="col-xs-12 col-md-2 has-feedback has-feedback-left">
                     ...
                     <label for="articulo_tra" style="float: left;">Codigo:</label><span style="margin-left: 10px;display: none;" id="cargandocodigo" ><i class="fa fa-spinner fa-pulse fa-fw"></i></span>
                  ...
                  <div class="col-xs-6 col-md-2">
                     ...
                     <input type="text" class="form-control form-control-sm text-right tiponumerico" name="costo_tra" id="costo_tra" disabled/>
                  </div>
                   <div class="col-xs-6 col-md-2">
                      <!--mostrar saldo en almacen de articulo segun codigo-->
                     <label>Saldo:</label>
                      <input type="text" class="form-control form-control-sm text-right tiponumerico" id="saldo_tra" name="saldo_tra" disabled/>
                  </div>
                 ...
                 <div class="form-group row filaarticulo"> <!--CUARTA FILA-->
                  ...
                  <div class="col-xs-4 col-md-2">
                      <input type="text" class="hidden" class="form-control form-control-sm tiponumerico" id="descuento_tra" name="descuento_tra" tabindex=12/>
                  </div>

                  <div class="col-xs-4 col-md-2">
                        <!--insertar cantidad de productos a ingresar-->
                      <label>Cantidad:</label>
                      <input type="text" class="form-control form-control-sm" id="cantidad_tra" name="cantidad_tra" tabindex=10/>
                  </div>
                  <div class="col-xs-4 col-md-2">
                      <!--insertar costo de articulo a ingresar-->
                      <label>Costo Bs:</label> 
                      <input type="text" class="form-control form-control-sm tiponumerico" id="punitario_tra" name="punitario_tra" tabindex=11/>
                  </div>
        ...
        <!--Tabla para mostrar articulos ingresados-->
            ...
            <div class="row">
                <div class="col-xs-12 col-md-12">
                  ...
                  <input type="text" class="form-control" id="obs_tra" name="obs_tra" value="<?= ($cont)?$dcab->obs:''  ?>" />
              </div>
                <hr>
            </div>
            <hr>
