      ...
      <div class="box-header with-border">
        ...
        <div class="box-body">
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">Home - Principal</h3>
                        <div class="box-body">
                            <form method="post" id="home">
                                <div class="row">
                                    <!-- titulo -->
                                    <div class="form-group col-sm-6 col-md-3">
                                        <label for="recepcion">Titulo:</label>
                                        <input type="text" class="form-control">
                                    </div>
                                     <!-- Descripcion -->
                                     <div class="form-group col-sm-6 col-md-4">
                                    <label for="recepcion">Descripción:</label>
                                        <textarea type="text" class="form-control"></textarea>
                                    </div>
                                    <!-- img -->
                                    <div class="form-group col-sm-6 col-md-3">
                                        <label for="recepcion">Imagen:</label>
                                        <input type="file" class="form-control">
                                    </div>
                                    <!-- video -->
                                    <div class="form-group col-sm-6 col-md-3">
                                        <label for="recepcion">Video:</label>
                                        <input type="file" class="form-control">
                                    </div>
                                </div>
                            </form>
