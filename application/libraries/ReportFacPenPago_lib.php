<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    class ReportFacPenPago_lib extends FPDF {
        private $datos = array();
        ...
        public function Header() {
            ...
            $this->Cell(0,8, utf8_decode("FACTURAS PENDIENTES DE PAGO"),0,1,'C');
            ...
            $this->Ln(15);
                    ...
                    $this->Cell(10,5,utf8_decode('Nº Fac.'),'B',0,'C',1);
                    //$this->Cell(15,5,utf8_decode('Lote'),'B',0,'C',1);
                    $this->Cell(85,5,utf8_decode('Cliente'),'B',0,'C',1);
                    $this->Cell(20,5,utf8_decode('Crédito'),'B',0,'R',1);
                    $this->Cell(20,5,'Abono','B',0,'R',1);
                    $this->Cell(20,5,'Saldo ','B',0,'R',1);
                    $this->Cell(25,5,utf8_decode('Responsable'),'B',0,'C',1);
                    $this->Ln(8);
        }
